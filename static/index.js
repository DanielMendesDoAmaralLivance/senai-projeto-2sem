...
const listOs = async () => {
  ...
  <span class="badge badge-secondary">Pendente</span>`
              ...
              service_order.title
                          ...
                          <div class="card-body">
                              <a href="#" class="card-link" onclick="openOsModal(${
                                service_order.id
                              })">Editar</a>
                              <a href="#" class="card-link text-danger" onclick="openConfirmOrRefuseModal(${
                                service_order.id
                              }, 'refuse-os')">Recusar</a>
                              <a href="#" class="card-link text-success" onclick="openConfirmOrRefuseModal(${
                                service_order.id
